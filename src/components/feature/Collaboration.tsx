  ...
  const data: { label: string; description: string }[] = [
    {
      label: "Więcej czasu",
      description:
        "Organizacja ślubu to ogrom telefonów, maili, analiza ofert podwykonawców, aby wyselekcjonować te najkorzystniejsze. I będziecie musieli to robić, jak się domyślam, popołudniami, po pracy lub w weekendy. Ja Wam mogę ten czas zaoszczędzić i dać gotowe propozycje podwykonawców, oparte na Waszych potrzebach.",
    },
    {
    ...
    },
    {
      label: "Zaufanie",
      description:
        "Bez tego ciężko się współpracuje. Dlatego bardzo ważne jest, aby przy wyborze, zarówno wedding plannera, jak i innych podwykonawców, poznać się wcześniej. W końcu będziecie z tymi ludźmi współpracować i powierzacie im jeden z najważniejszych dni w życiu. Czytając opinie klienta po realizacji, dociera do Ciebie, jakie to ważne w całym procesie realizacji.",
    },
    {
      label: "Pomoc",
      description:
