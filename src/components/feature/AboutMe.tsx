...
const AboutMe: FC = () => {
  ...
  return (
    <section className="relative mt-20 xl:mt-10">
      {isMobile ? <h2 className="text-xl md:text-2xl xl:text-3xl tracking-wider uppercase text-center pt-10">Kilka słów o mnie </h2> : null}
      ...
      <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row px-8 md:px-14 py-12 sm:py-20 items-center">
        <div className="relative h-full w-full aspect-[4/5] max-w-[640px]">
          <Image src={"/images/o-mnie2.jpeg"} alt="o-mnie" fill className="object-cover px-8 sm:px-12 md:px-0" />
        </div>
        <div className="max-w-4xl flex flex-col items-center lg:-ml-40 -mt-[40%] sm:-mt-80 md:-mt-[300px] lg:-mt-0 xl:-ml-24 lg:-mb-36">
          {!isMobile ? <h2 className="text-3xl tracking-widest uppercase">Kilka słów o mnie </h2> : null}
          <div
          ...
          >
            ...
            <p className="mt-4">
              Swoją przygodę zaczęłam od dekoracji ślubów i innych uroczystości, co doprowadziło mnie do organizacji i to jest właśnie to! Koordynacja dnia
              ślubu jest wisienką na torcie, zwieńczeniem wielomiesięcznej współpracy z Parą Młodą i podwykonawcami. Spędzonych wiele godzin przed komputerem,
