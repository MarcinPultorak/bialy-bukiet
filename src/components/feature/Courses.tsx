...
const Courses: FC = () => {
  return (
    <section className="py-10 mt-20 mx-auto w-full">
      <div className="flex flex-col max-w-screen-2xl w-full mx-auto ">
        <div className="flex">
          <Image src={"/images/dyplom1.png"} alt="dyplom1" width={550} height={750} className="object-cover" />
          <div className="w-full flex flex-col">
            <h2 className="uppercase text-5xl mt-5 self-center">Ukończone szkolenia</h2>
        ...
        <div className="flex">
          ...
          <Image src={"/images/dyplom2.png"} alt="dyplom1" width={550} height={750} className="object-cover -mt-80" />
        </div>
      </div>
    </section>
  );
