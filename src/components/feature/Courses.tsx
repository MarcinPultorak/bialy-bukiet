...
const Courses: FC = () => {
  ...
  return (
    <section className="py-10 mt-10 md:mt-20 mx-auto w-full">
      {isMobile1280 ? <h2 className="uppercase text-xl md:text-2xl xl:text-3xl tracking-wider mt-5 text-center mb-10">Ukończone szkolenia</h2> : null}
      <div className="flex flex-col max-w-screen-2xl w-full mx-auto lg:px-10">
        <div className="flex flex-col items-center lg:items-start lg:flex-row">
          ...
          <div className="w-full flex flex-col order-first lg:order-last">
            {!isMobile1280 ? <h2 className="uppercase text-xl md:text-2xl xl:text-3xl tracking-wider mt-5 self-center">Ukończone szkolenia</h2> : null}
