...
const PrivacyPolicy: FC = () => {
  const hClasses =
    "text-center text-slate-600 text-base sm:text-xl lg:text-2xl font-bold mt-12";
  const pClasses =
    "text-slate-600 text-justify text-xs sm:text-sm lg:text-base mt-4";
  const ulClasses =
    "text-slate-600 mt-4 list-disc list-inside space-y-1 text-xs sm:text-sm lg:text-base";

  return (
    <section className="max-w-screen-2xl mx-auto w-full h-full py-20 px-5 sm:px-10">
      <h2 className="text-center text-slate-600 text-3xl">
        Polityka Prywatności
      </h2>
      <h3 className={hClasses}>§ 1 Postanowienia ogólne</h3>
      <p className={pClasses}>
        1.Administratorem danych osobowych jest firma MAGDA GRAJEK-ANTONOWICZ
        EVENT, z siedzibą przy Łasko 52B, 73-240 Bierzwnik, o numerze NIP:
        2810057211. Z MAGDA GRAJEK-ANTONOWICZ EVENT można kontaktować się
        pisemnie na adres wskazany w zdaniu poprzedzającym lub drogą e-mailową
        na adres: bialybukietweddingplanner@gmail.com
      </p>
      <p className={pClasses}>
        2.Na podstawie Art. 37 RODO, firma "MAGDA GRAJEK-ANTONOWICZ EVENT" nie
        powołała Inspektora Ochrony Danych.
      </p>
      <p className={pClasses}>
        3.Polityka prywatności stanowi integralną część Regulaminu. Korzystając
        ...
        także zasady stosowania plików „Cookies”.
      </p>
      <p className={pClasses}>
        4.Informujemy, że przestrzegamy zasad ochrony danych osobowych oraz
      ...
      <p className={pClasses}>
        5.Na żądanie osoby, której dane osobowe są przetwarzane udzielamy
        ...
        gromadzimy, w jaki sposób je wykorzystujemy, jakim celom mają służyć i
        komu je przekazujemy, jaką zapewniamy ochronę tych danych przy
        przekazaniu innym podmiotom oraz udzielamy informacji o instytucjach, z
        którymi należy się skontaktować w razie wątpliwości.
      </p>
      <h3 className={hClasses}>§ 2 Zasady prywatności</h3>
      <p className={pClasses}>
        1.Szanujemy Twoją prywatność. Pragniemy zagwarantować Ci wygodę
        korzystania z naszych usług.
      </p>
      <p className={pClasses}>
        2.Cenimy zaufanie, jakim Nas obdarzasz, powierzając nam swoje dane
        osobowe w celu realizacji usług. Zawsze korzystamy z danych osobowych w
        sposób uczciwy oraz tak, aby nie zawieść Twojego zaufania, tylko w
        zakresie niezbędnym do realizacji usług.
      </p>
      <p className={pClasses}>
        3.Jako Użytkownik masz prawo do uzyskania pełnych i jasnych informacji o
        ...
        zbieramy, w jaki sposób i komu je udostępniamy oraz udzielamy informacji
        o podmiotach, z którymi należy się skontaktować w razie wątpliwości.
      </p>
      <p className={pClasses}>
        4.W razie wątpliwości odnośnie wykorzystywania przez nas Twoich danych
      ...
      <p className={pClasses}>
        5.Podejmiemy wszystkie uzasadnione działania, aby chronić Twoje dane
      ...
      <ul className={ulClasses}>
        <li>
          art. 6 ust. 1 lit. a osoba, której dane dotyczą wyraziła zgodę na
          przetwarzanie swoich danych osobowych w jednym lub większej
          liczbieokreślonych celów
        </li>
      </ul>
      <p className={pClasses}>
        7.Twoje dane osobowe związane z zawarciem i realizacją umowy
        ...
        cywilnego oraz ustawy o rachunkowości, tj. nie dłużej niż przez 10 lat,
        licząc od końca roku kalendarzowego w którym ostatnia umowa została
        wykonana.
      </p>
      <p className={pClasses}>
        8.Twoje dane osobowe przetwarzane w celu zawarcia i wykonania przyszłych
        umów będą przetwarzane do czasu zgłoszenia sprzeciwu.
      </p>
      <p className={pClasses}>
        9.Przysługuje Ci prawo do: dostępu do swoich danych osobowych i
        ...
        przewidzianych w art. 17 RODO; żądania ograniczenia przetwarzania danych
        w przypadkach wskazanych w art. 18 RODO, wniesienia sprzeciwu wobec
        przetwarzania danych w przypadkach wskazanych w art. 21 RODO,
        przenoszenia dostarczonych danych, przetwarzanych w sposób
        zautomatyzowany.
      </p>
      <p className={pClasses}>
        10.eżeli uważasz, że Twoje dane osobowe są przetwarzane niezgodnie z
        prawem, możecie wnieść skargę do organu nadzorczego (Urząd Ochrony
        Danych Osobowych, ul. Stawki 2, Warszawa). Jeśli potrzebujesz
        dodatkowych informacji związanych z ochroną danych osobowych lub chcesz
        skorzystać z przysługujących praw, skontaktuj się z nami listownie na
        adres korespondencyjny
      </p>
      <p className={pClasses}>
        11.Przestrzegamy wszystkich obowiązujących przepisów i regulacji
      ...
      <p className={pClasses}>
        13.Aby ułatwić nam odpowiedź bądź ustosunkowanie się do podanych
        informacji, prosimy o podanie imienia i nazwiska
      </p>
      <h3 className={hClasses}>§ 3 Zakres i cel zbierania danych osobowych</h3>
      <p className={pClasses}>
        1.Przetwarzamy niezbędne dane osobowe w celu realizacji usług oraz w
      ...
      <p className={pClasses}>
        3.Podanie powyższych danych przez jest całkowicie dobrowolne ale także i
      ...
      <p className={pClasses}>
        ...
        siedzibą w innych krajach w tym krajach z obszaru EOG (Europejski Obszar
        Gospodarczy, EOG ang. European Economic Area, EEA – strefa wolnego
        handlu i Wspólny Rynek, obejmujące państwa Unii Europejskiej i
      ...
      <p className={pClasses}>
        5.Dostęp do Twoich danych mogą posiadać podmioty świadczące dla usługi
      ...
      <p className={pClasses}>
        1.Stosuje pliki cookie lub podobne technologie (zwane dalej łącznie:
        ...
        ogólnych statystyk dotyczących korzystania przez użytkowników ze stron.
        Dane gromadzone przy użyciu plików cookie są zbierane wyłącznie w celu
        wykonywania określonych funkcji na rzecz Użytkowników i są zaszyfrowane
      ...
      <p className={pClasses}>
        3.W ramach naszej strony internetowej, stosowane są następujące rodzaje
      ...
      <p className={pClasses}>
        ...
        internetowa) zazwyczaj domyślnie dopuszcza przechowywanie plików cookie
        w urządzeniu końcowym. Użytkownik przeglądający stronę internetową może
        samodzielnie i w każdym czasie zmienić ustawienia dotyczące plików
        cookie, określając warunki ich przechowywania i uzyskiwania dostępu
        przez pliki cookie do swojego urządzenia. Zmiany ustawień, o których
        mowa w zdaniu poprzednim, Klient może dokonać za pomocą ustawień
        ...
        cookie w ustawieniach przeglądarki internetowej bądź informować o ich
        każdorazowym zamieszczeniu plików cookie na urządzeniu Użytkownika.
      ...
      <p className={pClasses}>
        5.Korzystanie ze strony internetowej, bez zmiany ustawień w zakresie
      ...
      <p className={pClasses}>
        1.Mamy prawo a w przypadkach prawem określonych także i ustawowy
        ...
        trzecim, które zgłoszą takie żądanie udzielenia informacji na podstawie
        obowiązujących przepisów prawa polskiego.
      </p>
      <p className={pClasses}>2.Użytkownik ma prawo do:</p>
      <ul className={ulClasses}>
        <li>
          dostępu do danych osobowych Użytkownikowi przysługuje prawo uzyskania
          dostępu do swoich danych osobowych, realizowane na żądanie złożone do
          Administratora
        </li>
        <li>
          sprostowania danych osobowych Użytkownikowi przysługuje prawo żądania
          od Administratora niezwłocznego sprostowania danych osobowych, które
          są nieprawidłowe lub / oraz uzupełnienia niekompletnych danych
          osobowych, realizowane na żądanie złożone do Administratora
        </li>
        <li>
          usunięcia danych osobowychUżytkownikowi przysługuje prawo żądania od
          Administratora niezwłocznego usunięcia danych osobowych, realizowane
          na żądanie złożone do Administratora W przypadku kont użytkowników,
          ...
          prowadzonej korespondencji). W przypadku usługi Newsletter, Użytkownik
          ma możliwość samodzielnego usunięcia swoich danych osobowych
          korzystając z odnośnika umieszczonego w każdej przesyłanej wiadomości
          e-mail.
        </li>
        <li>
          ograniczenia przetwarzania danych osobowych Użytkownikowi przysługuje
          prawo ograniczenia przetwarzania danych osobowych w przypadkach
          wskazanych w art. 18 RODO, m.in. kwestionowania prawidłowość danych
          osobowych, realizowane na żądanie złożone do Administratora
        </li>
        <li>
          przenoszenia danych osobowych Użytkownikowi przysługuje prawo
          uzyskania od Administratora, danych osobowych dotyczących Użytkownika
          w ustrukturyzowanym, powszechnie używanym formacie nadającym się do
          odczytu maszynowego, realizowane na żądanie złożone do Administratora
        </li>
        <li>
        ...
        <li>
          wniesienia skargi Użytkownikowi przysługuje prawo wniesienia skargi do
