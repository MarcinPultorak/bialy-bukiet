  ...
  return (
    <section className="max-w-screen-2xl flex flex-col lg:flex-row py-16 xl:py-24 px-16 items-center mx-auto lg:space-x-24">
      <div className="flex flex-col items-center max-w-3xl text-center">
        <h1 className="text-3xl sm:text-4xl xl:text-5xl">Witajcie! Cieszę się że tu jesteście!</h1>
        <p className="text-base sm:text-xl xl:text-2xl mt-12 xl:mt-20">
        ...
        <p className="text-base mt-4 sm:text-xl xl:text-2xl">Dajcie sobie pomóc aby ten dzień był niezapomniany!</p>
      ...
      >
        <Image src={"/images/powitanie.jpg"} alt="zdjęcie-powitalne" fill className="object-cover" />
