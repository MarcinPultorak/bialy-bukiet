      ...
      <section className="max-w-screen-2xl xl:mx-auto py-20">
        ...
        <div className="w-full px-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 md:gap-x-10 gap-y-10 xl:gap-y-0 mt-12 lg:mt-20">
          <div className="">
            ...
            <h3 className="text-yellow-700 text-base md:text-lg xl:text-xl tracking-widest text-center mt-4">
          ...
          <div className="">
            ...
            <h3 className="text-yellow-700 text-base md:text-lg lg:text-xl tracking-widest text-center mt-4">
        ...
        <div className="w-full px-10">
          <Link href={"/oferta"}>
            <Button
              variant="beige"
              className="md:max-w-xs mx-auto mt-12 lg:mt-20"
            >
              Sprawdź ofertę
            </Button>
          </Link>
