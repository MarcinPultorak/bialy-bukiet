            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              ...
              <ul className="mt-4">
                ...
                <li>
                  ...
                  catering, dobór menu, foto/wideo, dekoracje, słodki stół, mąkę
                  up, fryzjer itp
                </li>
                <li>
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              <p>
                ...
                harmonogramem. Możecie się do mnie zwrócić z każdym pytaniem, do
                czego zachęcam. Zawsze jesteście mile widziani.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              ...
              <ul className="mt-4">
                ...
                <li>
                  -nawiąże kontakt z podwykonawcami i prześle harmonogram
                  -jestem z Wami cały dzień ślubu do zakończenia poprawin czy
                  wszystkich atrakcji
                </li>
                <li>
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              ...
              <p className="mt-4">
                ...
                kontaktu po indywidualną wycenę.
              </p>
              <ul className="mt-4">
