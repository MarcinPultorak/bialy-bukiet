  ...
  return (
    <section>
      ...
      >
        ...
        />
        <h2 className=" text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white uppercase tracking-widest">
          Oferta
        </h2>
      </div>
      <div className="max-w-screen-2xl mx-auto w-full h-full py-10 md:py-20 px-5">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-y-5 lg:gap-y-0 lg:gap-x-5 mt-14 lg:mt-28">
          ...
          >
            <h2 className="sm:text-lg md:text-xl lg:text-2xl text-center text-yellow-700 tracking-wider">
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              <p>
                ...
                przygotowania. A może masz inne powody dla których potrzebne Ci
                wsparcie.
              </p>
              <p className="mt-4">
              ...
              <ul className="mt-4">
                ...
                <li>
                  - pomoc przy podpisywaniu umów i ich archiwizacja - stworzenie
                  wizji zaślubin jeżeli takiej nie macie
                </li>
                ...
                <li>
                  - koordynacja dnia ślubu od pojawienia się pierwszych
                  podwykonawców do ostatnich atrakcji na weselu
                </li>
                <li>- zadbanie w tym dniu o Parę Młodą i ich gości</li>
                <li>- kontrola harmonogramu wesela</li>
                <li>
                  - załatwianie wszelkich spraw które mają miejsce na weselu, a
                  nie były planowane
                </li>
                <li>- rozliczenie z podwykonawcami</li>
              </ul>
              <p className="mt-4">
                Nie jestem w stanie wymienić wszystkich aspektów związanych z
                organizacją i koordynacją, ale jestem z Wami na każdym etapie,
                pomagam przy każdym pojawiającym się problemie. Dbam o Was, o
                Waszych Gości, o wszystkich podwykonawców.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              <p>
                ...
                poradzić z jakąś częścią organizacji, to znaczy: jeżeli
                utknęliście na jakimś etapie, coś należy dopracować, lub pojawił
                się jakiś problem. Szukacie podwykonawcy, obiektu, macie problem
                z harmonogramem. Możecie się do mnie zwrócić z każdym pytaniem,
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              ...
              <ul className="mt-4">
                <li>- pomoc przy wyborze obiektu</li>
                <li>
                  - nasza współpraca zaczyna się jeszcze przed ślubem, abyście
                  mogli mi przekazać wszystkie informacje dotyczące dnia ślubu
                </li>
                <li>
                  - stworzę dla Was harmonogram dnia ślubu jeżeli nie macie
                  żadnego rozpisanego
                </li>
                <li>
                  - nawiążę kontakt z podwykonawcami i prześlę harmonogram -
                  jestem z Wami przez cały dzień ślubu do zakończenia poprawin
                  lub wszystkich innych atrakcji
                </li>
                <li>
                  - zadbam tego dnia o Was, Waszych gości oraz wszystkich
                  podwykonawców
                </li>
                <li>- kontrola harmonogramu wesela</li>
                <li>
              ...
              <p className="mt-4">
                Tego dnia jestem Waszym wsparciem na każdym etapie harmonogramu.
                :)
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-y-5 lg:gap-y-0 lg:gap-x-5 mt-14 lg:mt-28">
          ...
          >
            ...
            <div className="mt-6 lg:mt-12 text-slate-600 text-xs sm:text-sm lg:text-base">
              ...
              <p className="mt-4">
                Jeżeli interesuje Was dekoracja miejsca zaślubin, sali lub
                szukacie dekoratorki na inną okoliczność, to zapraszam Was do
                kontaktu po indywidualną wycenę. Usługi jaki wykonuję:
              </p>
              <ul className="mt-4">
              ...
              <p className="mt-4">
                Dekoracje sprawiają, że ważny dla Was dzień, staje się magiczny
                i niezwykły. Każdy dodatek cieszący nasze oko ma znaczenie, co
